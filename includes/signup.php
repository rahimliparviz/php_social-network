...
if (isset($_GET['step']) === true && empty($_GET['step']) === false) {
    ...
    if (isset($_POST['next'])) {
        ...
        if (!empty($username)) {
            ...
            } else if ($getFromUsers->checkUsername($username === true)) {
                $error = 'Username is already taken';
            } else {
                $getFromUsers->update('user', $user_id, array('username' => $username));
                ...
                <?php if ( $_GET['step'] == '2') { ?>
                    <div class='lets-wrapper'>
                        <div class='step-letsgo'>
                            <h2>We're glad you're here, <?php echo $user->nick_name?></h2>
